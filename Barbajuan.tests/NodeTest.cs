public class NodeTest
{
    ...
    public void UpdateNodeUpdatesAllParents()
    {
        ...
        var firstGenChildNode2 = new Node(null, new List<Node>(),null,new List<Card>(), 1, 1);
        var firstGenChildNode3 = new Node(null, new List<Node>(),null,new List<Card>(), 1, 1);
        var secondGenChildNode1 = new Node(null, new List<Node>(),null,new List<Card>(), 1, 1);
        var secondGenChildNode2 = new Node(null, new List<Node>(),null,new List<Card>(), 1, 1);
        var thirdGenChildNode1 = new Node(null, new List<Node>(),null,new List<Card>(), 1, 1);
    ...
    public void UCTMathTest()
    {
        ...
        var rootNode1 = new Node(null,new List<Node>(),null,new List<Card>(),2,2);
        var Node2 = new Node(null,new List<Node>(),null,new List<Card>(),2,2);

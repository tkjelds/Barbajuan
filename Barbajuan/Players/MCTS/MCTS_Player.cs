...
public class MCTS_Player : Iplayer
{
    ...
    public MCTS_Player(string name, int determinizations, int iterations, ImovePicker picker)
    {
        this.name = name;
    ...
    public MCTS_Player(List<Card> hand, int determinizations, int iterations, string name, ImovePicker picker)
    {
        this.hand = hand;
        this.determinizations = determinizations;
        this.iterations = iterations;
    ...
    public MCTS_Player(string name, int determinizations, int iterations)
    {
        this.name = name;
        this.determinizations = determinizations;
        this.iterations = iterations;
    ...
    public Iplayer Clone()
    {
        ...
        var clonedPlayer = new MCTS_Player(clonedHand, this.determinizations, this.iterations, this.name, this.picker);
        return clonedPlayer;
    }
